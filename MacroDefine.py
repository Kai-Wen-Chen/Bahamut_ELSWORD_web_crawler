...
SELECTION_CONTENT_SOURCE = 'Press the related number to select, online(1) / local(2) / exit(3):'
SELECTION_NEED_PAGE_RANGE = 'Press the related number to select, Yes(1) / No(2):'
SELECTION_WRITE_DATA = 'Press the related number to select, Yes(1) / No(2):'
